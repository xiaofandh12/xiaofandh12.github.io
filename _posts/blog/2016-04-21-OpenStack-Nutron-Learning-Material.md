...
* 一系列文章[Neutron 理解(1)：Neutron所实现的虚拟化网络(How Neutron Virtualizes Network)](http://www.cnblogs.com/sammyliu/p/4622563)
* [openstack(juno) 入门(总结篇)二十七:openstack排除故障及常见问题记录](http://www.aboutyun.com/thread-1178-1-1.html)
